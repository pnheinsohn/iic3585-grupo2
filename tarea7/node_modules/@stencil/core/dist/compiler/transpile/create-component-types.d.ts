import { ComponentMeta, ComponentRegistry, Config } from '../../declarations';
 ...
 */
export declare function generateComponentTypesFile(config: Config, cmpList: ComponentRegistry): string;
export declare function createStencilElement(): string;
/**
