...
function serializeAppCollection(config, collectionDir, entryModules, globalModule) {
...
function serializeComponentPath(config, collectionDir, moduleFile, compiledComponentAbsoluteFilePath, cmpData) {
...
function copyComponentAssets(config, compilerCtx, buildCtx) {
    return __awaiter$11(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield Promise.all(copyTasks.map((copyTask) => __awaiter$11(this, void 0, void 0, function* () {
...
function copyComponentStyles(config, compilerCtx, buildCtx) {
    return __awaiter$12(this, void 0, void 0, function* () {
        ...
        try {
            ...
            yield Promise.all(absSrcStylePaths.map((absSrcStylePath) => __awaiter$12(this, void 0, void 0, function* () {
...
class InMemoryFileSystem {
    ...
    copyDir(src, dest, opts) {
        return __awaiter$18(this, void 0, void 0, function* () {
            ...
            yield Promise.all(dirItems.map((dirItem) => __awaiter$18(this, void 0, void 0, function* () {
    ...
    removeDir(dirPath) {
        return __awaiter$18(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield Promise.all(dirItems.map((item) => __awaiter$18(this, void 0, void 0, function* () {
    ...
    commitWriteFiles(filesToWrite) {
        return Promise.all(filesToWrite.map((filePath) => __awaiter$18(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
    ...
    commitDeleteFiles(filesToDelete) {
        return Promise.all(filesToDelete.map((filePath) => __awaiter$18(this, void 0, void 0, function* () {
            if (typeof filePath !== 'string') {
...
function copySourceCollectionComponentsToDistribution(config, compilerCtx, modulesFiles) {
    return __awaiter$39(this, void 0, void 0, function* () {
        ...
        yield Promise.all(copyTasks.map((copyTask) => __awaiter$39(this, void 0, void 0, function* () {
            yield compilerCtx.fs.copy(copyTask.src, copyTask.dest);
        })));
    });
}
...
function initCollections(config, compilerCtx, buildCtx) {
    return __awaiter$42(this, void 0, void 0, function* () {
        ...
        return Promise.all(uninitialized.map((collection) => __awaiter$42(this, void 0, void 0, function* () {
            ...
            if (config.generateDistribution) {
                yield copySourceCollectionComponentsToDistribution(config, compilerCtx, collection.moduleFiles);
            }
...
function hydrateHtml(config, ctx, cmpRegistry, opts) {
    return new Promise(resolve => {
        ...
        plt.onAppLoad = (rootElm, styles, failureDiagnostic) => __awaiter$49(this, void 0, void 0, function* () {
            if (config._isTesting) {
...
function parseCollectionModule(config, compilerCtx, packageJsonFilePath, packageJsonData) {
...
function discoverCollections(config, compilerCtx, buildCtx) {
    return (transformContext) => {
        function visitImport(importNode) {
            if (!importNode.moduleSpecifier) {
                return importNode;
...
function scanDirForTsFiles(config, fs$$1, dir) {
    return __awaiter$54(this, void 0, void 0, function* () {
        ...
        yield Promise.all(tsFileItems.map((tsFileItem) => __awaiter$54(this, void 0, void 0, function* () {
